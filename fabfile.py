...
@task
def prod():
    env.prefix = 'source /home/webmaster/.virtualenvs/pangolinfog/bin/activate'
    env.user = 'webmaster'
    env.hosts = ['pangolinfog.com']
    env.path = '/home/webmaster/apps/pangolinfog'
    env.branch = 'master'
    env.db_name = 'pangolinfog'
    env.app = 'pangolinfog'
...
def test():
    env.prefix = 'source /home/webmaster/.virtualenvs/pangolinfog/bin/activate'
    env.user = 'webmaster'
    env.hosts = ['test.pangolinfog.com']
    env.path = '/home/webmaster/apps/pangolinfog'
    env.branch = 'master'
    env.db_name = 'pangolinfog'
    env.app = 'pangolinfog'
